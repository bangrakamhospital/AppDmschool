...
const Bloodpressure = ({ navigation }) => {
  ...
  const handleLogin = async () => {
        const response = await fetch('https://xn--72c0aoae1bkgb0asc2c1fc5b3eyfe6a.com/dmdash/dmbloodpressure/',{
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
  ...
  return (
	...
	<View style={styles.dropdownsRow}>
		  ...
		  <SelectDropdown
              ...
              defaultButtonText={'เลือกตัวเลขค่าบน'}
			...
			<SelectDropdown
              ...
              defaultButtonText={'เลือกตัวเลขค่าล่าง'}
              buttonTextAfterSelection={(selectedItem, index) => {
            ...
            onPress={handleLogin}
              activeOpacity={0.7} style={styles.loginBtn}>
                <Text style={styles.loginText}>  ส่งค่าความดันโลหิต</Text>
              </TouchableOpacity>
            </LinearGradient>
			</View>
